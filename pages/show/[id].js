    ...
    <div>
      ...
      {!session ? (
        ...
        <section className="relative z-50">
          ...
          <div className="absolute inset-y-96 md:inset-y-auto md:bottom-10 xl:bottom-28 inset-x-4 md:inset-x-12 space-y-6 z-[200]">
          ...
          <div
            className={`absolute top-3 inset-x-[7%] md:inset-x-[13%] rounded overflow-hidden transition duration-1000 ${
              showPlayer ? 'opacity-100 z-[1000]' : 'opacity-0'
            }`}
          >
            <div className="flex items-center justify-between bg-black text-[#f9f9f9] p-3.5">
              ...
              <div
                className="cursor-pointer w-8 h-8 flex justify-center items-center rounded-lg opacity-50 hover:opacity-80 hover:bg-[#0f0f0f]"
            ...
            <div className="relative pt-[56.25%] z-[300]">
              <ReactPlayer
